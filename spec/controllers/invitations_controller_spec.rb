  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Invitation" do
        expect {
          post :create, params: {invitation: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved invitation as @invitation" do
        post :create, params: {invitation: invalid_attributes}, session: valid_session
        expect(assigns(:invitation)).to be_a_new(Invitation)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested invitation" do
        invitation = Invitation.create! valid_attributes
        put :update, params: {id: invitation.to_param, invitation: new_attributes}, session: valid_session
        invitation.reload
      ...
      it "assigns the requested invitation as @invitation" do
        invitation = Invitation.create! valid_attributes
        put :update, params: {id: invitation.to_param, invitation: valid_attributes}, session: valid_session
        expect(assigns(:invitation)).to eq(invitation)
      end
    ...
    context "with invalid params" do
      it "assigns the invitation as @invitation" do
        invitation = Invitation.create! valid_attributes
        put :update, params: {id: invitation.to_param, invitation: invalid_attributes}, session: valid_session
        expect(assigns(:invitation)).to eq(invitation)
      end
