Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "standup_logs_#{Rails.env}"
  config.action_mailer.perform_caching = false

  config.action_mailer.asset_host = 'http://demo-sessionsapp.herokuapp.com'
  ...
  # Action Cable endpoint configuration
   ...
   # config.web_socket_server_url = "wss://demo-sessionsapp.herokuapp.com/cable"   #new added
